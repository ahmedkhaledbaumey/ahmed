...
if(isset($_POST['update']))
{
    ...
    move_uploaded_file($img_temp, $location);
    $updateEmpData = "UPDATE `lawyers` SET `name`='$name',`age`=$age,`address`='$address',`salary`=$salary,`yearsex`=$years_ex,`phone`='$phone',`email`='$email',`password`='$password',`image`='$location' WHERE `id` = $id";
  };
    ...
    <div class="card ">
        <div class="card-body">
            <form method="post" enctype="multipart/form-data">
                <div class="form-group"><img width="200" src="<?= $row[9] ?>" class="img-thumbnail"> <input type="file"
                        name="image"></div>
